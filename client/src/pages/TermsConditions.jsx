                    ...
                    <div className="p-8 md:p-12 space-y-8">
                        <div className="prose max-w-none text-gray-600">
                            <p className="text-lg leading-relaxed mb-8">
                                Welcome to Indian Kart. By accessing or using our website, you agree to be bound by these Terms and Conditions and our Privacy Policy. If you do not agree with any part of these terms, please do not use our services.
                            </p>
                        </div>
                        ...
                        <section>
                            ...
                            <p className="text-gray-600 leading-relaxed mb-4">
                                All content included on this site, such as text, graphics, logos, images, and software, is the property of Indian Kart or its content suppliers and protected by copyright laws.
                            </p>
                        </section>
                        ...
                        <section>
                            ...
                            <p className="text-gray-600 leading-relaxed mb-4">
                                Indian Kart shall not be liable for any direct, indirect, incidental, special, or consequential damages resulting from the use or inability to use our services.
                            </p>
                        </section>
                        ...
                        <div className="bg-gray-50 border-1 border-gray-200 p-6 rounded-lg mt-8">
                            ...
                            <p className="text-gray-600 text-sm">
                                For any questions regarding these Terms & Conditions, please contact us at <span className="font-semibold">legal@indiankart.com</span>.
                            </p>
                        </div>
                    </div>
                </div>
