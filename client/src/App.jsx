...
function AppContent() {
  ...
  React.useEffect(() => {
    // Dynamic Title
    document.title = isAdminRoute ? "Admin Panel | Indian Kart" : "Indian Kart | Store";
    ...
    if (isAdminRoute) {
      ...
      link.href = `data:image/svg+xml,<svg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220 0 100 100%22><rect width=%22100%22 height=%22100%22 rx=%2220%22 fill=%22%23ea580c%22/><path d=%22M30 30 H75 L70 60 H35 L30 30 Z M35 70 A5 5 0 1 0 35 80 A5 5 0 1 0 35 70 Z M65 70 A5 5 0 1 0 65 80 A5 5 0 1 0 65 70 Z%22 fill=%22white%22/></svg>`;
    }
