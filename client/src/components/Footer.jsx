                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    ...
                    <div className="space-y-6">
                        <Link to="/" className="text-3xl font-bold flex items-center gap-2">
                            <span className="text-primary">Indian</span>Kart
                        </Link>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-gray-400">
                            ...
                            <li className="flex items-center gap-3">
                                ...
                                <span className="text-sm">support@indiankart.com</span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="border-t border-gray-800 pt-8 mt-8">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                        <p className="text-gray-500 text-sm">
                            © {new Date().getFullYear()} Indian Kart. All rights reserved.
                        </p>
                        <p className="flex items-center gap-1 text-gray-500 text-sm">
                            Designed with <Heart className="w-4 h-4 text-red-500 fill-red-500 animate-pulse" /> by Indian Kart
                        </p>
                    </div>
                </div>
            </div>
